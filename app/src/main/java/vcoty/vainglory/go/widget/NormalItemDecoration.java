...
public class NormalItemDecoration extends FlexibleDividerDecoration {
	private MarginProvider mMarginProvider;

    protected NormalItemDecoration(Builder builder) {
        super(builder);
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public NormalItemDecoration build() {
            checkBuilderParams();
            return new NormalItemDecoration(this);
        }
    }
}
